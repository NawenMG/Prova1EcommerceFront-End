...
@Component({
  ...
  templateUrl: './delivery-ui.component.html',
  styleUrls: ['./delivery-ui.component.css'],
  standalone: true
})
export class SegnalazioniUiComponent implements OnInit {
  ...
  initSegnalazione(): void {
    ...
    this.newSegnalazione = {
      id: '', // L'id verrà generato dal server
...
@Component({
  ...
  imports: [HeaderComponent, CommonModule, FormsModule, FooterComponent],
  templateUrl: './delivery-ui.component.html',
  styleUrl: './delivery-ui.component.css'
})
export class DeliveryUiComponent {
  // Configurazione per la prima tabella
